...
"Panel 1: Worm's-Eye View. Pancreatic tail, large glucagonoma tumor glowing amber, glucagon molecules streaming into portal vein like thick golden smoke. "

"Panel 2: Bird's-Eye View. Liver acinus, hepatocytes grabbing amino acids from portal blood, hands pulling glowing pellets from bloodstream, converting them into glucose chains glowing warm orange. "

"Panel 3: Dolly Zoom In. Peripheral blood vessel, amino acid levels dropping, blood turning from rich amber to pale watery blue. Labeled amino acids vanishing. "

"Panel 4: Crash Zoom In. Skin basal layer, keratinocyte cells with arms reaching up for amino acid supply, receiving nothing, hands grasping empty air, cells beginning to separate from each other. "

"Panel 5: Through Object In. Stratum spinosum, desmosome bridges between keratinocytes snapping one by one, golden connections breaking into dust, epidermal layers peeling apart like dry paper. "

"Panel 6: Low angle close-up. Skin surface, blister forming, fluid pooling between separated epidermal layers, the roof of the blister translucent and fragile, warm amber fluid beneath. "

"Panel 7: Wide establishing shot. Groin and perineal skin, rash spreading in migratory pattern, edges of lesion vivid red with active peeling, center healing silver-pink, new lesion blooming adjacent. "
...
"Panel 9: Push in. Patient in bed, surgical scar on abdomen healing, skin rash resolved, color returned to face. Glucagonoma removed. Normoglycemic. Skin intact. No longer eating itself. "
