...
PROMPT = open(os.path.join(OUT, "descent-contrast-3x3.claude-img.txt"), encoding="utf-8").read()
...
for i in range(120):
    ...
    if status.upper() == "COMPLETED":
        ...
        if generated:
            ...
            out_path = os.path.join(OUT, "pku-newborn-contrast-3x3.png")
