...
CASE = "osa-enuresis"
OUT = os.path.join(r"C:\Users\steve\MeWorld\dev\screenshots", f"osa-nocturnal-enuresis-2026-07-28", "images")
...
PLATES = [
    ("descent-3x3", "osa-enuresis-descent-3x3.png"),
]
